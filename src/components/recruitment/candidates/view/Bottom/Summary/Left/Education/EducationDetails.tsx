...
export default function EducationDetails ({ data }: Props) {
      ...
      <div className='flex-1'>
        ...
        {data.candidateEducations.length === 0 && (
          <section className='p-3 py-5 w-full border-2 border-t-0 flex justify-between items-center p-5 flex-col gap-2'>
            ...
            <button
              onClick={() => {
                setModalState({ isOpen: true, type: 'education' })
              }}
